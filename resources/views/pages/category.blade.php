 ...
 <section class="block-inner">
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    <h1>Tin {{$theloai->TenTL}} </h1>
                    <div class="breadcrumbs">
                        <ul>
                            <li><i class="pe-7s-home"></i> <a href="/" title="">Home</a></li>
                            <li><a href="{{$theloai->TenTL_KhongDau}}" title="">{{$theloai->TenTL}}</a></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-8">
                <?php 
                    $tin = $theloai->tin()->orderBy('idTin','desc')->paginate(10);
                 ?>
                @foreach($tin as $t)
                <div class="col-sm-6 post-style1">
                    ...
                    <!-- post title -->
                    <h4 style="height: 50px"><a href="{{$theloai->TenTL_KhongDau}}/{{$t->loaitin->Ten_KhongDau}}/{{$t->TieuDe_KhongDau}}">{{$t->TieuDe}}</a></h4>
